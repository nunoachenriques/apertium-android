...
public class ApertiumInstallation {
     ...
     */
    public final Map<String, String> titleToMode = new HashMap<>();
    /**
     * Given a mode name, like 'es-eo', find its package name (eo-es).
     * This map is intentionally not encapsulated. Don't misuse, its only for reading
     */
    public final Map<String, String> modeToPackage = new HashMap<>();
    /**
     * List of observers to notify after a rescan.
     * The run() method will be executed by the UI thread
     */
    public final List<Runnable> observers = new ArrayList<>();
     ...
     * NOTE: To avoid code injection attacks this should be placed in a private place, inaccessible for others
     */
